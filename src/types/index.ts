...
// Состояние карточки товара в каталоге (галерее)
...
// Состояние детальной карточки товара (в модальном окне превью)
...
// Состояние всей корзины (список отрисованных элементов и общая сумма)
...
// Состояние формы оформления заказа (расширяет базовую форму полями адреса и оплаты)
